  ...
  return (
    <>
      <Navbar bg="dark" variant="dark" style={{ height: "80px" }}>
        <Container>
          <NavLink to="/" className="text-decoration-none text-light mx-3" style={{ fontSize: 30, background: "red", padding: 8 }} >ZOMATO</NavLink>
...

          {
            getdata.length ?
              ...
              <div className='card_details d-flex justify-content-center align-items-center' style={{ width: "20rem", padding: 10, position: "relative" }}>
                <i class='fa fa-close'
                  onClick={handleClose}
                  style={{ position: "absolute", top: 2, right: 20, fontSize: 20, cursor: "pointer" }}></i>
